<img src="docs/assets/banner.png" align="center">

App is a community of software developers, researchers, and user
...
The App team is a diverse community which includes individuals
...
to customer service, to creative writing.
     ...
     2. Note that some of the image generation AI models which the app
     ...
     are distinct from the MIT license which applies to the app
     software and source code.

6. That mutual respect is key to a healthy software development
community. Members of the app community are expected to treat
...
This document has been collectively crafted and approved, we are all in agreement about its fundamental statements, as well as their significance and importance to this project moving forward.
