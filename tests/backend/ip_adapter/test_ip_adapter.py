...
from aittor.backend.model_manager import BaseModelType, ModelType, SubModelType
from aittor.backend.stable_diffusion.diffusion.unet_attention_patcher import UNetAttentionPatcher
...
@pytest.mark.parametrize(
    ...
    [
        # SD1.5, IPAdapter
        {
            "ip_adapter_model_id": "aittorai/ip_adapter_sd15",
        ...
        # SD1.5, IPAdapterPlus
        {
            "ip_adapter_model_id": "aittorai/ip_adapter_plus_sd15",
        ...
        # SD1.5, IPAdapterFull
        {
            "ip_adapter_model_id": "aittorai/ip-adapter-full-face_sd15",
