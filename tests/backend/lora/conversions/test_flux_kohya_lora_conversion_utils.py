...
from aittor.backend.flux.util import params
from aittor.backend.lora.conversions.flux_kohya_lora_conversion_utils import (
    _convert_flux_transformer_kohya_state_dict_to_aittor_format,
    is_state_dict_likely_in_flux_kohya_format,
    lora_model_from_flux_kohya_state_dict,
)
from aittor.backend.lora.conversions.flux_lora_constants import FLUX_LORA_CLIP_PREFIX, FLUX_LORA_TRANSFORMER_PREFIX
...
def test_convert_flux_transformer_kohya_state_dict_to_aittor_format():
    # Construct state_dict from state_dict_keys.
    state_dict = keys_to_mock_state_dict(flux_kohya_state_dict_keys)

    converted_state_dict = _convert_flux_transformer_kohya_state_dict_to_aittor_format(state_dict)
...
def test_convert_flux_transformer_kohya_state_dict_to_aittor_format_error():
    """Test that an error is raised by _convert_flux_transformer_kohya_state_dict_to_aittor_format() if the input
    ...
    with pytest.raises(ValueError):
        _convert_flux_transformer_kohya_state_dict_to_aittor_format(state_dict)
