...
from aittor.app.services.shared.sqlite_migrator.sqlite_migrator_common import (
    MigrateCallback,
    Migration,
    MigrationError,
    MigrationSet,
...
from aittor.app.services.shared.sqlite_migrator.sqlite_migrator_impl import (
    SqliteMigrator,
)
...
def test_migrator_runs_all_migrations_file(logger: Logger) -> None:
    with TemporaryDirectory() as tempdir:
        original_db_path = Path(tempdir) / "aittor.db"
