...
from aittor.backend.model_manager import BaseModelType, ModelRepoVariant
from aittor.backend.model_manager.config import InvalidModelConfigException, MainDiffusersConfig, ModelVariantType
from aittor.backend.model_manager.probe import (
    CkptType,
    ModelProbe,
    VaeFolderProbe,
...
def test_probe_handles_state_dict_with_integer_keys():
    # This structure isn't supported by aittor, but we still need to handle it gracefully. See #6044
