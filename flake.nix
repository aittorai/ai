...
# Python environment for APP. Instead, it depends on local invocations of
...
{
  description = "An (impure) flake to develop on APP.";
  ...
  outputs = { self, nixpkgs }:
    let
      ...
      mkShell = { dir, install }:
        let
          setupScript = pkgs.writeScript "setup-web" ''
