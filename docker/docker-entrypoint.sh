...
### Set APP_ROOT pointing to a valid runtime directory
...
#   docker run --rm -it -v /some/path:/aittor -e CONTAINER_UID=$(id -u) <this image>
...
mkdir -p "${APP_ROOT}"
chown --recursive ${USER} "${APP_ROOT}" || true
cd "${APP_ROOT}"
