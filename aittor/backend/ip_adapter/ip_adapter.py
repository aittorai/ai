...
from aittor.backend.ip_adapter.ip_attention_weights import IPAttentionWeights
from aittor.backend.ip_adapter.resampler import Resampler
...
class IPAdapter(RawModel):
    ...
    def calc_size(self) -> int:
        ...
        from aittor.backend.model_manager.load.model_util import calc_module_size
