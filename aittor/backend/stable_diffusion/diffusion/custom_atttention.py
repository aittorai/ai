...
from aittor.backend.ip_adapter.ip_attention_weights import IPAttentionProcessorWeights
from aittor.backend.stable_diffusion.diffusion.regional_ip_data import RegionalIPData
from aittor.backend.stable_diffusion.diffusion.regional_prompt_data import RegionalPromptData
...
class CustomAttnProcessor2_0(AttnProcessor2_0):
    """A custom implementation of AttnProcessor2_0 that supports additional app features.
