...
from aittor.backend.stable_diffusion.diffusion.conditioning_data import IPAdapterData, TextConditioningData
from aittor.backend.stable_diffusion.diffusion.shared_aittor_diffusion import AppDiffuserComponent
from aittor.backend.stable_diffusion.diffusion.unet_attention_patcher import UNetAttentionPatcher, UNetIPAdapterData
from aittor.backend.stable_diffusion.extensions.preview import PipelineIntermediateState
from aittor.backend.util.attention import auto_detect_slice_size
...
class StableDiffusionGeneratorPipeline(StableDiffusionPipeline):
    ...
    def __init__(
        ...
        self.aittor_diffuser = AppDiffuserComponent(self.unet, self._unet_forward)
    ...
    def _adjust_memory_efficient_attention(self, latents: torch.Tensor):
        ...
        # See https://github.com/aittorai/AI/issues/7049 for context.
        ...
        if max_size_required_for_baddbmm > (mem_free * 3.0 / 4.0):  # 3.3 / 4.0 is from old App code
    ...
    def latents_from_embeddings(
        ...
        if use_ip_adapter or use_regional_prompting:
            ...
            attn_ctx = unet_attention_patcher.apply_ip_adapter_attention(self.aittor_diffuser.model)
    ...
    def step(
        ...
        # aittor_diffuser has batched timesteps, but diffusers schedulers expect a single value
        timestep = t[0]
        ...
        #     i.e. before or after passing it to AppDiffuserComponent
        ...
        if control_data is not None:
            down_block_additional_residuals, mid_block_additional_residual = self.aittor_diffuser.do_controlnet_step(
                control_data=control_data,
        ...
        uc_noise_pred, c_noise_pred = self.aittor_diffuser.do_unet_step(
            sample=latent_model_input,
        ...
        noise_pred = self.aittor_diffuser._combine(uc_noise_pred, c_noise_pred, guidance_scale)
