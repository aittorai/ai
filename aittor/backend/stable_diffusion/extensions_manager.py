...
from aittor.app.services.session_processor.session_processor_common import CanceledException
...
if TYPE_CHECKING:
    ...
    from aittor.backend.stable_diffusion.extensions.base import CallbackFunctionWithMetadata, ExtensionBase
