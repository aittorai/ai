...
from aittor.backend.quantization.scripts.load_flux_model_bnb_nf4 import log_time
...
def main():
    ...
    model_path = Path(
        "/data/aittor/models/.download_cache/https__huggingface.co_black-forest-labs_flux.1-schnell_resolve_main_flux1-schnell.safetensors/flux1-schnell.safetensors"
    )
