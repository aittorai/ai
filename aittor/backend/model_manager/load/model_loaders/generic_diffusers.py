...
"""Class for simple diffusers model loading in app."""
...
class GenericDiffusersLoader(ModelLoader):
    ...
    def _hf_definition_to_type(self, module: str, class_name: str) -> ModelMixin:  # fix with correct type
        if module in [
            "diffusers",
            "transformers",
            "aittor.backend.quantization.fast_quantized_transformers_model",
            "aittor.backend.quantization.fast_quantized_diffusion_model",
        ]:
