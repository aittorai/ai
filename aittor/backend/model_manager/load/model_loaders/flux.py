# Copyright (c) 2024, Brandon W. Rising and APP Development Team
"""Class for Flux model loading in app."""
...
from aittor.backend.flux.util import ae_params, params
...
from aittor.backend.model_manager.util.model_util import (
    convert_bundle_to_flux_transformer_checkpoint,
)
from aittor.backend.quantization.gguf.loaders import gguf_sd_loader
from aittor.backend.quantization.gguf.utils import TORCH_COMPATIBLE_QTYPES
from aittor.backend.util.silence_warnings import SilenceWarnings

try:
    from aittor.backend.quantization.bnb_llm_int8 import quantize_model_llm_int8
    from aittor.backend.quantization.bnb_nf4 import quantize_model_nf4
