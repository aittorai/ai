...
from aittor.backend.model_manager import AnyModel, SubModelType
from aittor.backend.model_manager.load.memory_snapshot import MemorySnapshot, get_pretty_snapshot_diff
from aittor.backend.model_manager.load.model_cache.model_cache_base import (
    CacheRecord,
    CacheStats,
    ModelCacheBase,
    ModelLockerBase,
)
from aittor.backend.model_manager.load.model_cache.model_locker import ModelLocker
from aittor.backend.model_manager.load.model_util import calc_model_size_by_data
...
class ModelCache(ModelCacheBase[AnyModel]):
    ...
    def __init__(
        ...
        :param log_memory_usage: If True, a memory snapshot will be captured before and after every model cache
            ...
            behaviour.
        :param logger: AppLogger to use (otherwise creates one)
        """
        ...
        self._logger = logger or AppLogger.get_logger(self.__class__.__name__)
