...
Usage:
```
from aittor.backend.model_manager.util.select_hf_files import select_hf_model_files
...
from aittor.backend.model_manager.config import ModelRepoVariant
...
def filter_files(
    ...
    as defined in `aittor.backend.model_manager.metadata.metadata_base`.
    """
