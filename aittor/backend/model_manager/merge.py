"""
aittor.backend.model_manager.merge exports:
...
from aittor.app.services.model_install import ModelInstallServiceBase
from aittor.app.services.model_records.model_records_base import ModelRecordChanges
from aittor.backend.model_manager import AnyModelConfig, BaseModelType, ModelType, ModelVariantType
from aittor.backend.model_manager.config import MainDiffusersConfig
...
class ModelMerger(object):
    ...
    def merge_diffusion_models_and_save(
        ...
        **kwargs: Any,
        ...
        """
        :param models: up to three models, designated by their registered App model name
