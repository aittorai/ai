...
import aittor.backend.util.logging as logger
from aittor.app.util.misc import uuid_string
from aittor.backend.flux.controlnet.state_dict_utils import (
    is_state_dict_instantx_controlnet,
    is_state_dict_xlabs_controlnet,
)
from aittor.backend.lora.conversions.flux_diffusers_lora_conversion_utils import (
    is_state_dict_likely_in_flux_diffusers_format,
)
from aittor.backend.lora.conversions.flux_kohya_lora_conversion_utils import is_state_dict_likely_in_flux_kohya_format
from aittor.backend.model_hash.model_hash import HASHING_ALGORITHMS, ModelHash
...
from aittor.backend.model_manager.util.model_util import lora_token_vector_length, read_checkpoint_meta
from aittor.backend.quantization.gguf.ggml_tensor import GGMLTensor
from aittor.backend.quantization.gguf.loaders import gguf_sd_loader
from aittor.backend.spandrel_image_to_image_model import SpandrelImageToImageModel
        ...
        if model_type is ModelType.Main:
            if base_type == BaseModelType.Flux:
                ...
                if (
                    ...
                    # For flux, this is a key in aittor.backend.flux.util.params
            ...
            config_file = (
                # For flux, this is a key in aittor.backend.flux.util.ae_params
                #   Due to model type and format being the descriminator for model configs this
                #   is used rather than attempting to support flux with separate model types and format
                #   If changed in the future, please fix me
                "flux"
