...
Typical usage:
  ...
  from aittor.backend.model_manager import ModelConfigFactory
...
from aittor.backend.model_hash.hash_validator import validate_hash
...
# RawModel is the AI wrapper class for ip_adapters, loras, textual_inversion and onnx runtime
AnyModel = Union[
...
class IPAdapterAppConfig(IPAdapterBaseConfig):
    """Model config for IP Adapter diffusers format models."""

    image_encoder_model_id: str
    format: Literal[ModelFormat.Aittor]

    @staticmethod
    def get_tag() -> Tag:
        return Tag(f"{ModelType.IPAdapter.value}.{ModelFormat.Aittor.value}")
...
AnyModelConfig = Annotated[
    Union[
        ...
        Annotated[IPAdapterAppConfig, IPAdapterAppConfig.get_tag()],
