...
Example usage:
```
    from aittor.backend.model_manager import ModelSearch, ModelProbe
...
class ModelSearch:
    ...
    def __init__(
        ...
        Args:
            on_search_started: callback to be Operator when the search starts
            on_model_found: callback to be Operator when a model is found. The callback should return True if the model
                should be included in the results.
            on_search_completed: callback to be Operator when the search is completed
        """
