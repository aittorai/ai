export type paths = {
    ...
    "/api/v2/models/i/{key}": {
         ...
         *     deleted as well if they reside within the App "models" directory.
         */
    ...
    "/api/v2/models/model_cache": {
        ...
        /**
         * Set maximum size of model manager RAM or VRAM cache, optionally writing new value out to aittor.yaml config file.
...
export type components = {
    schemas: {
        ...
        CLIPEmbedDiffusersConfig: {
            ...
            /**
             * Path
             * @description Path to the model on the filesystem. Relative paths are relative to the App root directory.
             */
            path: string;
            /**
             * Name
        ...
        /**
         * Core Metadata
         * @description Used internally collect metadata for generations.
         */
         ...
         * @enum {string}
         */
        ModelFormat: "diffusers" | "checkpoint" | "lycoris" | "onnx" | "olive" | "embedding_file" | "embedding_folder" | "aittor" | "t5_encoder" | "bnb_quantized_int8b" | "bnb_quantized_nf4b" | "gguf_quantized";
        ...
        UIConfigBase: {
            ...
            /**
             * Node Pack
             * @description The node pack that this node belongs to, will be 'aittor' for built-in nodes
             */
            node_pack: string;
            /**
    ...
    set_cache_size: {
        parameters: {
            query: {
                ...
                /** @description The cache type */
                cache_type?: components["schemas"]["CacheType"];
                /** @description Write new value out to aittor.yaml */
                persist?: boolean;
            };
            header?: never;
            path?: never;
