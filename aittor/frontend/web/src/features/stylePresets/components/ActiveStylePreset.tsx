import { Badge, Flex, IconButton, Spacer, Text, Tooltip } from '@aittorai/ui-library';
...
export const ActiveStylePreset = () => {
  ...
  return (
    <Flex w="full" alignItems="center" gap={2} minW={0}>
      ...
      <Badge colorScheme="appBlue" variant="subtle" justifySelf="flex-start">
      ...
      <Tooltip label={t('stylePresets.toggleViewMode')}>
        <IconButton
          ...
          colorScheme={viewMode ? 'appBlue' : 'base'}
          icon={<PiEyeBold />}
        />
      </Tooltip>
