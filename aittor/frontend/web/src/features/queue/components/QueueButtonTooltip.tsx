import type { TooltipProps } from '@aittorai/ui-library';
import { Divider, Flex, ListItem, Text, Tooltip, UnorderedList } from '@aittorai/ui-library';
...
const TooltipContent = memo(({ prepend = false }: { prepend?: boolean }) => {
  ...
  const addingTo = useMemo(() => {
    ...
    return t('parameters.aittor.addingImagesTo');
  }, [sendToCanvas, t]);
