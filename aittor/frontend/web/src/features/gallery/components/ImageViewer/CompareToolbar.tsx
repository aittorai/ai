        ...
        <Flex gap={2} marginInlineEnd="auto">
          ...
          {comparisonMode !== 'side-by-side' && (
            <IconButton
              ...
              colorScheme={comparisonFit === 'fill' ? 'appBlue' : 'base'}
              variant="outline"
      ...
      <Flex flex={1} gap={4} justifyContent="center">
        <ButtonGroup variant="outline">
          <Button
            ...
            colorScheme={comparisonMode === 'slider' ? 'appBlue' : 'base'}
          >
            {t('gallery.slider')}
          </Button>
          <Button
            ...
            colorScheme={comparisonMode === 'side-by-side' ? 'appBlue' : 'base'}
          >
          ...
          <Button
            ...
            colorScheme={comparisonMode === 'hover' ? 'appBlue' : 'base'}
          >
            {t('gallery.hover')}
          </Button>
        </ButtonGroup>
