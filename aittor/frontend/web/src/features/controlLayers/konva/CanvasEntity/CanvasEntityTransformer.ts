...
const DEFAULT_CONFIG: CanvasEntityTransformerConfig = {
  ...
  OUTLINE_PADDING: 0,
  OUTLINE_COLOR: 'hsl(200 76% 50% / 1)', // appBlue.500
  SCALE_ANCHOR_FILL_COLOR: 'hsl(200 76% 50% / 1)', // appBlue.500
  SCALE_ANCHOR_STROKE_COLOR: 'hsl(200 76% 77% / 1)', // appBlue.200
  SCALE_ANCHOR_CORNER_RADIUS_RATIO: 0.5,
  SCALE_ANCHOR_STROKE_WIDTH: 2,
  SCALE_ANCHOR_SIZE: 8,
  ROTATE_ANCHOR_FILL_COLOR: 'hsl(200 76% 95% / 1)', // appBlue.50
  ROTATE_ANCHOR_STROKE_COLOR: 'hsl(200 76% 40% / 1)', // appBlue.700
