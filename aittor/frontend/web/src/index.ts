export { default as AppUI } from './app/components/AppUI';
export type { StudioInitAction } from './app/hooks/useStudioInitAction';
export type { PartialAppConfig } from './app/types/aittor';
export { default as ParamMainModelSelect } from './features/parameters/components/MainModel/ParamMainModelSelect';
export { default as AppLogoComponent } from './features/system/components/AppLogoComponent';
