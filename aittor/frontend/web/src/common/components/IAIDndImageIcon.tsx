import type { IconButtonProps, SystemStyleObject } from '@aittorai/ui-library';
...
const sx: SystemStyleObject = {
  ...
  svg: {
    ...
    fill: 'base.100',
    _hover: { fill: 'base.50' },
    filter: `drop-shadow(0px 0px 0.1rem var(--app-colors-base-900))
      drop-shadow(0px 0px 0.3rem var(--app-colors-base-900))
      drop-shadow(0px 0px 0.3rem var(--app-colors-base-900))`,
  },
};
