...
from aittor.app.invocations.model import CLIPField
from aittor.app.invocations.primitives import ConditioningOutput
from aittor.app.services.shared.invocation_context import InvocationContext
from aittor.app.util.ti_utils import generate_ti_list
...
class CLIPSkipInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> CLIPSkipInvocationOutput:
