...
from aittor.app.util.controlnet_utils import CONTROLNET_MODE_VALUES, CONTROLNET_RESIZE_VALUES
...
class MetadataItemInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> MetadataItemOutput:
...
class MetadataInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> MetadataOutput:
...
class CoreMetadataInvocation(BaseInvocation):
    """Used internally collect metadata for generations."""
