...
from aittor.app.invocations.model import CLIPField, LoRAField, ModelIdentifierField, TransformerField
...
class FluxLoRALoaderInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> FluxLoRALoaderOutput:
