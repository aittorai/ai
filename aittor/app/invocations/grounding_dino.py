...
from aittor.app.invocations.fields import BoundingBoxField, ImageField, InputField
from aittor.app.invocations.primitives import BoundingBoxCollectionOutput
from aittor.app.services.shared.invocation_context import InvocationContext
from aittor.backend.image_util.grounding_dino.detection_result import DetectionResult
...
class GroundingDinoInvocation(BaseInvocation):
    ...
    @torch.no_grad()
    def proceed(self, context: InvocationContext) -> BoundingBoxCollectionOutput:
