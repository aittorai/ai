...
from aittor.app.invocations.fields import FieldDescriptions, ImageField, InputField, OutputField, UIType
...
class FluxControlNetInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> FluxControlNetOutput:
