...
from aittor.app.invocations.fields import FieldDescriptions, InputField, OutputField, UIType
from aittor.app.invocations.model import CLIPField, ModelIdentifierField, UNetField, VAEField
from aittor.app.services.shared.invocation_context import InvocationContext
from aittor.backend.model_manager import SubModelType
...
class SDXLModelLoaderInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> SDXLModelLoaderOutput:
...
class SDXLRefinerModelLoaderInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> SDXLRefinerModelLoaderOutput:
        model_key = self.model.key
