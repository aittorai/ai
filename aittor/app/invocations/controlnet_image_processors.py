...
from aittor.app.invocations.util import validate_begin_end_step, validate_weights
from aittor.app.services.shared.invocation_context import InvocationContext
from aittor.app.util.controlnet_utils import CONTROLNET_MODE_VALUES, CONTROLNET_RESIZE_VALUES, heuristic_resize
from aittor.backend.image_util.canny import get_canny_edges
from aittor.backend.image_util.depth_anything.depth_anything_pipeline import DepthAnythingPipeline
from aittor.backend.image_util.dw_openpose import DWPOSE_MODELS, DWOpenposeDetector
from aittor.backend.image_util.hed import HEDProcessor
from aittor.backend.image_util.lineart import LineartProcessor
from aittor.backend.image_util.lineart_anime import LineartAnimeProcessor
from aittor.backend.image_util.util import np_to_pil, pil_to_np
...
class ControlNetInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> ControlOutput:
