...
from aittor.backend.image_util.invisible_watermark import InvisibleWatermark
from aittor.backend.image_util.safety_checker import SafetyChecker
...
class ImageWatermarkInvocation(BaseInvocation, WithMetadata, WithBoard):
    ...
    image: ImageField = InputField(description="The image to check")
    text: str = InputField(default="Aittor", description="Watermark text")
