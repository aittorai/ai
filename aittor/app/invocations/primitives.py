...
class BooleanInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> BooleanOutput:
...
class BooleanCollectionInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> BooleanCollectionOutput:
...
class IntegerInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> IntegerOutput:
...
class IntegerCollectionInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> IntegerCollectionOutput:
...
class FloatInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> FloatOutput:
...
class FloatCollectionInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> FloatCollectionOutput:
...
class StringInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> StringOutput:
...
class StringCollectionInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> StringCollectionOutput:
...
class ImageCollectionInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> ImageCollectionOutput:
...
class LatentsCollectionInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> LatentsCollectionOutput:
...
class ColorInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> ColorOutput:
...
class ConditioningInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> ConditioningOutput:
...
class ConditioningCollectionInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> ConditioningCollectionOutput:
...
class BoundingBoxInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> BoundingBoxOutput:
