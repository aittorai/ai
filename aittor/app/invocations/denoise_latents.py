...
from aittor.app.invocations.controlnet_image_processors import ControlField
...
from aittor.app.invocations.ip_adapter import IPAdapterField
from aittor.app.invocations.model import ModelIdentifierField, UNetField
from aittor.app.invocations.primitives import LatentsOutput
from aittor.app.invocations.t2i_adapter import T2IAdapterField
from aittor.app.services.shared.invocation_context import InvocationContext
from aittor.app.util.controlnet_utils import prepare_control_image
from aittor.backend.ip_adapter.ip_adapter import IPAdapter
from aittor.backend.lora.lora_model_raw import LoRAModelRaw
from aittor.backend.lora.lora_patcher import LoRAPatcher
from aittor.backend.model_manager import BaseModelType, ModelVariantType
from aittor.backend.model_patcher import ModelPatcher
from aittor.backend.stable_diffusion import PipelineIntermediateState
from aittor.backend.stable_diffusion.denoise_context import DenoiseContext, DenoiseInputs
from aittor.backend.stable_diffusion.diffusers_pipeline import (
    ControlNetData,
...
from aittor.backend.stable_diffusion.diffusion.custom_atttention import CustomAttnProcessor2_0
from aittor.backend.stable_diffusion.diffusion_backend import StableDiffusionBackend
from aittor.backend.stable_diffusion.extension_callback_type import ExtensionCallbackType
from aittor.backend.stable_diffusion.extensions.controlnet import ControlNetExt
from aittor.backend.stable_diffusion.extensions.freeu import FreeUExt
from aittor.backend.stable_diffusion.extensions.inpaint import InpaintExt
from aittor.backend.stable_diffusion.extensions.inpaint_model import InpaintModelExt
from aittor.backend.stable_diffusion.extensions.lora import LoRAExt
from aittor.backend.stable_diffusion.extensions.preview import PreviewExt
from aittor.backend.stable_diffusion.extensions.rescale_cfg import RescaleCFGExt
from aittor.backend.stable_diffusion.extensions.seamless import SeamlessExt
from aittor.backend.stable_diffusion.extensions.t2i_adapter import T2IAdapterExt
from aittor.backend.stable_diffusion.extensions_manager import ExtensionsManager
from aittor.backend.stable_diffusion.schedulers import SCHEDULER_MAP
...
from aittor.backend.util.hotfixes import ControlNetModel
from aittor.backend.util.mask import to_standard_float_mask
from aittor.backend.util.silence_warnings import SilenceWarnings
...
class DenoiseLatentsInvocation(BaseInvocation):
    ...
    def init_scheduler(
        ...
        if "generator" in scheduler_step_signature.parameters:
            ...
            # reproducibility.
            #
            # These supported schedulers accept a generator as of 2024-06-04:
            #   - DDIMScheduler
            #   - DDPMScheduler
    ...
    def proceed(self, context: InvocationContext) -> LatentsOutput:
        if os.environ.get("USE_MODULAR_DENOISE", False):
            return self._new_proceed(context)
        else:
            return self._old_proceed(context)

    @torch.no_grad()
    @SilenceWarnings()  # This quenches the NSFW nag from diffusers.
    def _new_proceed(self, context: InvocationContext) -> LatentsOutput:
    ...
    @torch.no_grad()
    @SilenceWarnings()  # This quenches the NSFW nag from diffusers.
    def _old_proceed(self, context: InvocationContext) -> LatentsOutput:
        seed, noise, latents = self.prepare_noise_and_latents(context, self.noise, self.latents)
