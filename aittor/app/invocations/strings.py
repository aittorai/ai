# 2023 APP Development Team

import re

from aittor.app.invocations.baseinvocation import BaseInvocation, BaseInvocationOutput, invocation, invocation_output
from aittor.app.invocations.fields import InputField, OutputField, UIComponent
from aittor.app.invocations.primitives import StringOutput
...
class StringSplitNegInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> StringPosNegOutput:
        p_string = ""
        n_string = ""
        brackets_depth = 0
        escaped = False
...
class StringSplitInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> String2Output:
