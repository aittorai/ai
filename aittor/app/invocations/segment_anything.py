...
from aittor.app.invocations.fields import BoundingBoxField, ImageField, InputField, TensorField
from aittor.app.invocations.primitives import MaskOutput
from aittor.app.services.shared.invocation_context import InvocationContext
from aittor.backend.image_util.segment_anything.mask_refinement import mask_to_polygon, polygon_to_mask
...
class SegmentAnythingInvocation(BaseInvocation):
    ...
    @torch.no_grad()
    def proceed(self, context: InvocationContext) -> MaskOutput:
