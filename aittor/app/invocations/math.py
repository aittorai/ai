...
from aittor.app.invocations.fields import FieldDescriptions, InputField
from aittor.app.invocations.primitives import FloatOutput, IntegerOutput
...
class IntegerMathInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> IntegerOutput:
        # Python doesn't support switch statements until 3.10, but app supports back to 3.9
