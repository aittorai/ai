...
from aittor.app.invocations.fields import FieldDescriptions, Input, InputField, OutputField, UIType
from aittor.app.services.shared.invocation_context import InvocationContext
from aittor.app.shared.models import FreeUConfig
from aittor.backend.flux.util import max_seq_lengths
...
class ModelIdentifierInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> ModelIdentifierOutput:
...
class FluxModelLoaderInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> FluxModelLoaderOutput:
...
class MainModelLoaderInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> ModelLoaderOutput:
...
class LoRALoaderInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> LoRALoaderOutput:
...
class LoRASelectorInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> LoRASelectorOutput:
...
class SDXLLoRALoaderInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> SDXLLoRALoaderOutput:
        lora_key = self.lora.key
...
class VAELoaderInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> VAEOutput:
...
class SeamlessModeInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> SeamlessModeOutput:
...
class FreeUInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> UNetOutput:
