...
from aittor.app.invocations.model import UNetField, VAEField
...
from aittor.backend.model_manager.config import MainConfigBase, ModelVariantType
...
class CreateGradientMaskInvocation(BaseInvocation):
    ...
    @torch.no_grad()
    def proceed(self, context: InvocationContext) -> GradientMaskOutput:
