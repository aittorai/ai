...
from aittor.app.invocations.fields import ImageField, Input, InputField, OutputField, WithBoard, WithMetadata
...
from aittor.backend.tiles.utils import Tile
...
class CalculateImageTilesInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> CalculateImageTilesOutput:
...
class TileToPropertiesInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> TileToPropertiesOutput:
...
class PairTileImageInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> PairTileImageOutput:
