...
from aittor.app.invocations.constants import DEFAULT_PRECISION
from aittor.app.invocations.fields import FieldDescriptions, ImageField, Input, InputField
from aittor.app.invocations.image_to_latents import ImageToLatentsInvocation
from aittor.app.invocations.model import VAEField
from aittor.app.invocations.primitives import DenoiseMaskOutput
...
class CreateDenoiseMaskInvocation(BaseInvocation):
    ...
    @torch.no_grad()
    def proceed(self, context: InvocationContext) -> DenoiseMaskOutput:
