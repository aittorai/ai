...
import aittor.assets.fonts as font_assets
from aittor.app.invocations.baseinvocation import (
    BaseInvocation,
    invocation,
    invocation_output,
)
from aittor.app.invocations.fields import ImageField, InputField, OutputField, WithBoard, WithMetadata
...
class FaceOffInvocation(BaseInvocation, WithMetadata):
    ...
    def proceed(self, context: InvocationContext) -> FaceOffOutput:
...
class FaceMaskInvocation(BaseInvocation, WithMetadata):
    ...
    def proceed(self, context: InvocationContext) -> FaceMaskOutput:
        image = context.images.get_pil(self.image.image_name)
