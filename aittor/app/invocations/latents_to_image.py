...
from aittor.app.invocations.constants import DEFAULT_PRECISION, LATENT_SCALE_FACTOR
...
from aittor.backend.stable_diffusion.vae_tiling import patch_vae_tiling_params
