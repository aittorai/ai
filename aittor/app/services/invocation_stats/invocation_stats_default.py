...
from aittor.app.services.invocation_stats.invocation_stats_common import (
...
from aittor.backend.model_manager.load.model_cache import CacheStats
...
class InvocationStatsService(InvocationStatsServiceBase):
    ...
    def collect_stats(self, invocation: BaseInvocation, graph_execution_state_id: str) -> Generator[None, None, None]:
        ...
        # during some tests.
        services = self._operator.services
