# Copyright 2023 APP Development Team
...
from aittor.app.services.model_install.model_install_common import ModelInstallJob, ModelSource
from aittor.app.services.model_records import ModelRecordChanges, ModelRecordServiceBase
from aittor.backend.model_manager import AnyModelConfig


class ModelInstallServiceBase(ABC):
    """Abstract base class for Aittor model installation."""
    ...
    def __init__(
        ...
        :param config: Systemwide AIAppConfig.
        :param store: Systemwide ModelConfigStore
        :param event_bus: AI event bus for reporting events to.
        """
    ...
    @property
    @abstractmethod
    def app_config(self) -> AIAppConfig:
    ...
    def install_path(
        ...
        the models directory handled by Aittor.
    ...
    def download_and_cache_model(self, source: str | AnyHttpUrl) -> Path:
        ...
        supported by Aittor. The downloading process takes advantage of the download queue
