# Copyright (c) APP Development Team
"""Implementation of multithreaded download queue for app."""
...
from aittor.app.services.config import AIAppConfig, get_config
...
from aittor.app.util.misc import get_iso_timestamp
...
class DownloadQueueService(DownloadQueueServiceBase):
    ...
    def __init__(
        ...
        app_config: Optional[AIAppConfig] = None,
        ...
        self._logger = AppLogger.get_logger("DownloadQueueService")
