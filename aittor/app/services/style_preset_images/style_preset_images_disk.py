...
from aittor.app.services.style_preset_images.style_preset_images_common import (
    StylePresetImageFileDeleteException,
    StylePresetImageFileNotFoundException,
    StylePresetImageFileSaveException,
)
from aittor.app.services.style_preset_records.style_preset_records_common import PresetType
from aittor.app.util.misc import uuid_string
from aittor.app.util.thumbnails import make_thumbnail
...
class StylePresetImageFileStorageDisk(StylePresetImageFileStorageBase):
    ...
    def get_path(self, style_preset_id: str) -> Path:
        style_preset = self._operator.services.style_preset_records.get(style_preset_id)
    ...
    def get_url(self, style_preset_id: str) -> str | None:
        ...
        url = self._operator.services.urls.get_style_preset_image_url(style_preset_id)
