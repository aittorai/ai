...
class MemoryInvocationCache(InvocationCacheBase):
    ...
    def start(self, operator: Operator) -> None:
        ...
        if self._max_cache_size == 0:
            return
        self._operator.services.images.on_deleted(self._delete_by_match)
        self._operator.services.tensors.on_deleted(self._delete_by_match)
        self._operator.services.conditioning.on_deleted(self._delete_by_match)
    ...
    def _delete_by_match(self, to_match: str) -> None:
        with self._lock:
            ...
            for key in keys_to_delete:
                self._delete(key)
            self._operator.services.logger.debug(
