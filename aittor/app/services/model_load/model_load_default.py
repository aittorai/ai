...
from aittor.backend.model_manager import AnyModel, AnyModelConfig, SubModelType
from aittor.backend.model_manager.load import (
    LoadedModel,
    LoadedModelWithoutConfig,
    ModelLoaderRegistry,
    ModelLoaderRegistryBase,
)
from aittor.backend.model_manager.load.model_cache.model_cache_base import ModelCacheBase
...
class ModelLoadService(ModelLoadServiceBase):
    ...
    def __init__(
        ...
        logger = AppLogger.get_logger(self.__class__.__name__)
    ...
    def load_model(self, model_config: AnyModelConfig, submodel_type: Optional[SubModelType] = None) -> LoadedModel:
        ...
        # We don't have an operator during testing
        # TODO(psyche): Mock this method on the operator in the tests
        if hasattr(self, "_operator"):
            self._operator.services.events.emit_model_load_started(model_config, submodel_type)
        ...
        if hasattr(self, "_operator"):
            self._operator.services.events.emit_model_load_complete(model_config, submodel_type)
