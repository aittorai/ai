...
from aittor.backend.model_manager.load import LoadedModel, LoadedModelWithoutConfig
...
class ModelLoadServiceBase(ABC):
    ...
    def load_model_from_path(
        ...
        argument is provided, the loader will be Operator to load the model into
