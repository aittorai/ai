...
from aittor.app.invocations import *  # noqa: F401 F403
...
from aittor.app.invocations.fields import Input, InputField, OutputField, UIType
...
class IterateInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> IterateInvocationOutput:
...
class CollectInvocation(BaseInvocation):
    ...
    def proceed(self, context: InvocationContext) -> CollectInvocationOutput:
        """App with provided services and return outputs."""
