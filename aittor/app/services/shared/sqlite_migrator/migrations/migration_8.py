...
class Migration8Callback:
    def __init__(self, app_config: AIAppConfig) -> None:
    ...
    def _migrate_abs_models_to_rel(self, cursor: sqlite3.Cursor) -> None:
        """Check all model paths & legacy config paths to determine if they are inside App-managed directories. If
...
def build_migration_8(app_config: AIAppConfig) -> Migration:
    """
