...
from aittor.app.invocations.constants import IMAGE_MODES
from aittor.app.invocations.fields import MetadataField, WithBoard, WithMetadata
...
from aittor.app.services.image_records.image_records_common import ImageCategory, ResourceOrigin
...
from aittor.app.services.model_records.model_records_base import UnknownModelException
from aittor.app.services.session_processor.session_processor_common import ProgressImage
from aittor.app.util.step_callback import flux_step_callback, stable_diffusion_step_callback
...
from aittor.backend.model_manager.load.load_base import LoadedModel, LoadedModelWithoutConfig
...
if TYPE_CHECKING:
    ...
    from aittor.app.services.session_queue.session_queue_common import SessionQueueItem
...
class ModelsInterface(InvocationContextInterface):
    ...
    def load_local_model(
        ...
        If a loader callable is provided, it will be Operator to load the model. Otherwise,
    ...
    def load_remote_model(
        ...
        If the a loader callable is provided, it will be Operator to load the model. Otherwise,
        `safetensors.torch.load_file()` or `torch.load()` will be called to load the model.
