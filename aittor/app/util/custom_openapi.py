...
from aittor.app.invocations.baseinvocation import BaseInvocation, BaseInvocationOutput, UIConfigBase
from aittor.app.invocations.fields import InputFieldJSONSchemaExtra, OutputFieldJSONSchemaExtra
...
def get_openapi_func(
    ...
    def openapi() -> dict[str, Any]:
        ...
        openapi_schema = get_openapi(
            title=app.title,
            description="An API for app AI image operations",
            version="1.0.0",
            routes=app.routes,
