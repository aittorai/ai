...
from aittor.app.services.shared.pagination import PaginatedResults
from aittor.app.services.shared.sqlite.sqlite_common import SQLiteDirection
from aittor.app.services.workflow_records.workflow_records_common import (
    Workflow,
    WorkflowCategory,
...
async def get_workflow(
    ...
    """Gets a workflow"""
    try:
        return ApiDependencies.operator.services.workflow_records.get(workflow_id)
...
async def update_workflow(
    ...
    """Updates a workflow"""
    return ApiDependencies.operator.services.workflow_records.update(workflow=workflow)
...
async def delete_workflow(
    ...
    """Deletes a workflow"""
    ApiDependencies.operator.services.workflow_records.delete(workflow_id)
...
async def create_workflow(
    ...
    """Creates a workflow"""
    return ApiDependencies.operator.services.workflow_records.create(workflow=workflow)
...
async def list_workflows(
    ...
    return ApiDependencies.operator.services.workflow_records.get_many(
