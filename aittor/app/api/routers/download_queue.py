...
from aittor.app.services.download import (
    DownloadJob,
...
async def list_downloads() -> List[DownloadJob]:
    ...
    queue = ApiDependencies.operator.services.download_queue
...
async def get_download_job(
    ...
    try:
        job = ApiDependencies.operator.services.download_queue.id_to_job(id)
        return job
...
async def cancel_all_download_jobs() -> Response:
    ...
    ApiDependencies.operator.services.download_queue.cancel_all_jobs()
    return Response(status_code=204)
