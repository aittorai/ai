...
async def list_boards(
    ...
    if all:
        return ApiDependencies.operator.services.boards.get_all(include_archived)
    elif offset is not None and limit is not None:
        return ApiDependencies.operator.services.boards.get_many(offset, limit, include_archived)
    else:
        raise HTTPException(
            status_code=400,
